...
(let* ((color-bg      "#000000")
  ...
  (custom-theme-set-faces 'matrix
   ...
   `(error ((t (:foreground ,color-red :background ,color-bg-red :weight bold))))
   ...
   `(font-lock-doc-face ((t (:inherit fixed-pitch-serif :slant italic))))
   `(font-lock-constant-face ((t (:foreground ,color-middle))))
   `(font-lock-function-name-face ((t (:foreground ,color-middle :weight bold :slant italic))))
   `(font-lock-keyword-face ((t (:foreground ,color-middle))))
   `(font-lock-string-face ((t (:foreground ,color-fg :background ,color-bg-alt :inherit fixed-pitch-serif))))
   `(font-lock-type-face ((t (:foreground ,color-middle))))
   `(font-lock-variable-name-face ((t (:foreground ,color-middle :slant italic))))
   ...
   `(header-line ((t (:foreground ,color-dark :underline t))))
