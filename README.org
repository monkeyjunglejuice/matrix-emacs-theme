...
If you have issues with the theme or something looks odd, please open an issue or send a pull request ([[https://github.com/monkeyjunglejuice/matrix-emacs-theme/branches/all][using the 'devel' branch]], or make a separate feature branch in your repository clone). You are very welcome to add support for further packages/modes. See also [[*Current Status]['Current Status']]
